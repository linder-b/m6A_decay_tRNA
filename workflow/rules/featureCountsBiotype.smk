rule featureCountsBiotype_SE:
    ...
    output:
        counts=logs_dir+'/{experiment}/featureCountsBiotype/{species}_{build}_{release}/{run}.featureCountsBiotype.txt',
        summary=logs_dir+'/{experiment}/featureCountsBiotype/{species}_{build}_{release}/{run}.featureCountsBiotype.txt.summary',
        mqc=logs_dir+'/{experiment}/featureCountsBiotype/{species}_{build}_{release}/{run}_biotype_counts_mqc.txt',
        gs_mqc=logs_dir+'/{experiment}/featureCountsBiotype/{species}_{build}_{release}/{run}_biotype_counts_gs_mqc.tsv'
    threads: 6
    conda:
